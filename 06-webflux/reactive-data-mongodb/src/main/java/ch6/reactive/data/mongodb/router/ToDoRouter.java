package ch6.reactive.data.mongodb.router;

import ch6.reactive.data.mongodb.handler.ToDoHandler;
...
public class ToDoRouter {
    ...
    public RouterFunction<ServerResponse> monoRouterFunction(ToDoHandler toDoHandler) {
        return route(GET("/todo/{id}").and(accept(APPLICATION_JSON)), toDoHandler::getToDo)
                ...
                .andRoute(POST("/todo").and(accept(APPLICATION_JSON)), toDoHandler::createToDo);
    }
}
