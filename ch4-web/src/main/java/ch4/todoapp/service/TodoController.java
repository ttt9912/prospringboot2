package ch4.todoapp.service;

import ch4.todoapp.data.ToDo;
import ch4.todoapp.data.ToDoRepository;
import ch4.todoapp.validation.ToDoValidationError;
import ch4.todoapp.validation.ToDoValidationErrorBuilder;
 ...
 *
 * # ResponseEntity
 * - Returns a full response including headers & body
 *
 */
@RestController
@RequestMapping("/api")
