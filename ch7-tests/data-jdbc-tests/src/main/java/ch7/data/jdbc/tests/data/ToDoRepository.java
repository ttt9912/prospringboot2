package ch7.data.jdbc.tests.data;
...
public class ToDoRepository {
    ...
    public ToDoRepository(final NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
    ...
    public Iterable<ToDo> findAll() {
        return this.namedParameterJdbcTemplate.query(SQL_FIND_ALL, toDoRowMapper);
    }
